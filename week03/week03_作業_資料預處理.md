...
|------|------|
| 正確區分數值型與類別型欄位 | 5 分 |
| 數值管道建立正確（填補 + 標準化） | 10 分 |
| 類別管道建立正確（填補 + 獨熱編碼） | 10 分 |
| ColumnTransformer 整合正確且可執行 | 10 分 |
| 輸出結果完整，欄位名稱與資料形狀正確 | 5 分 |
...
| 項目 | 配分 |
|------|------|
| Q1 正確說明數值型與類別型的處理差異，並解釋錯誤使用的後果 | 8 分 |
| Q2 三種策略的適用情境說明正確，各有具體例子 | 7 分 |
| Q3 Pipeline 的優點至少兩個，說明合理 | 5 分 |
